...
// container.innerHTML = CardValidator.markup;
// const value = '4276';
// const visa = container.querySelector('.visa');
// const  mastercard = container.querySelector('.mastercard');

// test('define payment system', () => {
//     getPaymentSystem(value);
//     expect(visa.classList.contains('disable')).toBe(false);
//     expect(mastercard.classList.contains('disable')).toBe(true);
// })
